<template>
  <div>
    <el-dialog title="浏览数据" :visible.sync="curVisible" @closed="handleClosed()" append-to-body v-dialog-drag>
      ...
      <el-row :gutter="20" class="view-line">
        <el-col :md="4" class="view-label">金额 :</el-col>
        <el-col :md="20">{{ curInfo.fee_money }}</el-col>
      </el-row>
      <el-row :gutter="20" class="view-line">
      ...
      <el-row :gutter="20" class="view-line">
        <el-col :md="4" class="view-label">收款方 :</el-col>
        <el-col :md="20">{{ collectClientIdParam[curInfo.collect_client_id] }}</el-col>
      </el-row>
      <el-row :gutter="20" class="view-line">
